...
export const TRACKER_METRICS: TrackerMetric[] = [
  { id: 'vit-d', name: 'Vitamin D', icon: 'light_mode', unit: 'ng/mL', normalRange: '30–100', color: '#f59e0b', codes: ['VITD', 'VIT-D', 'VITAMIN_D'] },
  { id: 'hba1c', name: 'HbA1c', icon: 'water_drop', unit: '%', normalRange: '< 5.7', color: '#ef4444', codes: ['HBA1C', 'HB_A1C', 'GLYCATED_HGB'] },
  { id: 'chol', name: 'Cholesterol', icon: 'favorite', unit: 'mg/dL', normalRange: '< 200', color: '#3b82f6', codes: ['CHOL', 'CHOLESTEROL', 'TOTAL_CHOL'] },
  { id: 'tsh', name: 'TSH', icon: 'scatter_plot', unit: 'µIU/mL', normalRange: '0.5–4.5', color: '#8b5cf6', codes: ['TSH', 'THYROID_TSH'] },
  { id: 'fbs', name: 'Fasting Glucose', icon: 'vaccines', unit: 'mg/dL', normalRange: '70–100', color: '#10b981', codes: ['FBS', 'GLU', 'GLUCOSE', 'FASTING_BLOOD_SUGAR'] },
  { id: 'cbc', name: 'Hemoglobin', icon: 'biotech', unit: 'g/dL', normalRange: '12–17', color: '#06b6d4', codes: ['HGB', 'HB', 'HEMOGLOBIN'] },
];
