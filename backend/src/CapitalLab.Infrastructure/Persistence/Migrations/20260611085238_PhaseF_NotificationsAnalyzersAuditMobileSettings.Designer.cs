...
namespace CapitalLab.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260611085238_PhaseF_NotificationsAnalyzersAuditMobileSettings")]
    partial class PhaseF_NotificationsAnalyzersAuditMobileSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CapitalLab.Domain.Entities.Analyzers.Analyzer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_analyzers_branch_id");

                    b.ToTable("analyzers", "laboratory");
                });

            modelBuilder.Entity("CapitalLab.Domain.Entities.Analyzers.AnalyzerImport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_analyzer_imports");

                    b.HasIndex("AnalyzerId")
                        .HasDatabaseName("ix_analyzer_imports_analyzer_id");

                    b.HasIndex("SampleId")
                        .HasDatabaseName("ix_analyzer_imports_sample_id");

                    b.ToTable("analyzer_imports", "laboratory");
                });

            modelBuilder.Entity("CapitalLab.Domain.Entities.Analyzers.AnalyzerResult", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<Guid>("AnalyzerImportId")
                        .HasColumnType("uuid")
                        .HasColumnName("analyzer_import_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_analyzer_results");

                    b.HasIndex("AnalyzerImportId")
                        .HasDatabaseName("ix_analyzer_results_analyzer_import_id");

                    b.HasIndex("LabTestId")
                        .HasDatabaseName("ix_analyzer_results_lab_test_id");

                    b.HasIndex("SampleId")
                        .HasDatabaseName("ix_analyzer_results_sample_id");

                    b.ToTable("analyzer_results", "laboratory");
                });
            ...
            modelBuilder.Entity("CapitalLab.Domain.Entities.Analyzers.AnalyzerImport", b =>
                {
                    b.HasOne("CapitalLab.Domain.Entities.Analyzers.Analyzer", "Analyzer")
                        .WithMany("Imports")
                        .HasForeignKey("AnalyzerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_analyzer_imports_analyzers_analyzer_id");
            ...
            modelBuilder.Entity("CapitalLab.Domain.Entities.Analyzers.AnalyzerResult", b =>
                {
                    b.HasOne("CapitalLab.Domain.Entities.Analyzers.AnalyzerImport", "Import")
                        .WithMany("Results")
                        .HasForeignKey("AnalyzerImportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_analyzer_results_analyzer_imports_analyzer_import_id");
